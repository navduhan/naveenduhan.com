...
const ColoredLine = ({ color }) => (
  ...
  class Publications extends Component {
    ...
    //   }
      ...
      render() {
        return (
            <Container className="Publications-header" fluid={true}>
              <Helmet>
                    <meta charSet="utf-8" />
                    <title>Publications | Naveen Duhan</title>
                    <link rel="canonical" href="http://naveenduhan.com/publications" />
               ...
               <Particles
                ...
                className="particle"
              />
               <Row className="Publications-main">
                  <HamburgerMenu />
                 <Col xl={8}className="Publications-left-main-col">
      ...
      <Card.Body>
        ...
        <h4>
             <ReactTypingEffect
              ...
              <Row className="Publications-footer">
                <Footer />
              </Row>
               </Animate>
           </Container>
